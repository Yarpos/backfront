...
//         var servicios = new[]
//         {
//             new { id = 1, nombre = "Soporte TI", descripcion = "Soporte técnico empresarial" },
//             new { id = 2, nombre = "Desarrollo Web", descripcion = "Aplicaciones web modernas" },
//             new { id = 3, nombre = "Consultoría", descripcion = "Asesoría tecnológica" },
//             new { id = 4, nombre = "Tesoreria", descripcion = "Recibir moneiii" },
//             new { id = 5, nombre = "Papeleria", descripcion = "Sandiegoooo" }
